...
import {
  Award, MapPin, Calendar, ExternalLink, CheckCircle2, Sparkles,
  Building2, GraduationCap, Code2, ArrowUpRight
} from 'lucide-react';
...
const Training = ({ data }) => {
  ...
  return (
    <section id="training" className="py-24 relative bg-white dark:bg-neutral-950 border-t border-neutral-100 dark:border-neutral-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          ...
          >
            Structured professional training program focused on Data Analytics, Python, SQL, and Business Intelligence at QSpiders Gurugram.
          </motion.p>
        </div>
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-12">
            ...
            {/* Left Column: Image + Quick Stats + Action */}
            <div className="lg:col-span-5 relative bg-neutral-100 dark:bg-neutral-900/60 p-6 sm:p-8 flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-neutral-200/80 dark:border-neutral-800/80">
              
              <div className="space-y-6">
                {/* Branch Image Container */}
                <div className="relative rounded-2xl overflow-hidden aspect-video sm:aspect-[16/10] border border-neutral-200 dark:border-neutral-800 shadow-md group">
                  <img
                    src={imgError ? '/images/about-ai-ds.jpg' : image}
                    alt={institute}
                ...
                <div className="space-y-3 font-mono text-xs text-neutral-600 dark:text-neutral-400">
                  ...
                  <div className="flex items-center gap-2.5 p-3 rounded-xl bg-white/60 dark:bg-neutral-800/60 border border-neutral-200/60 dark:border-neutral-700/60">
                    ...
                    <div>
                      ...
                      <div className="font-semibold text-neutral-900 dark:text-white truncate max-w-[240px]">{location}</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-6 mt-6 border-t border-neutral-200/60 dark:border-neutral-800/60">
                <a
                  href={website}
                  target="_blank"
            ...
            {/* Right Column: Detailed Program Content & Key Learnings */}
